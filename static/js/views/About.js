...
export async function getHtmlAsync() {
   ...
   <hr> 
   <p class="contact-information">Ако преглеждате сайта от телефон, натиснете върху дадения телефон за да звъннете автоматично или на вайбър телефона за да отоврите вайбър контакта автоматично.</p>
       ...
       1. Kаравани, ремаркета, коли, бусове, скутери, екипировка за каравани, миялни машини, перални, печки, хладилници, гуми, джанти - нови и втора употреба - продукти - Нов Внос от Дания. 
       </br>
       </br>
       ...
       4. Транспорт с пътна помощ и репатрак.
       </br>
       </br>
       5. Каравани в България и Дания.
       </br>
       </br>
