...
function phoneViberNumberInfoHtml(phone, viberPhone) {
    return ` <span title="Натиснете за да звъннете по телефона"><a href="tel:00359${phone.substring(1)}"><img src="static/img/icons/phone.png"><font size="3"><b>Тел: </b><u>${phone}</u></font></a></span></br>
